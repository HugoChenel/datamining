![](Aspose.Words.ceeb7072-5c8f-4e76-8f0c-70d51bed5023.001.jpeg)

**Identification et Classification de systèmes  ABC![](Aspose.Words.ceeb7072-5c8f-4e76-8f0c-70d51bed5023.002.png)**

Dans le cadre de l’UE “Fouille de données” par R. Barriot CHENEL Hugo
...
![](Aspose.Words.ceeb7072-5c8f-4e76-8f0c-70d51bed5023.003.png)
...
![](Aspose.Words.ceeb7072-5c8f-4e76-8f0c-70d51bed5023.004.png)

Fig. 2 : Processus d’extraction de connaissances à partir de bases de données

<https://touriaelouahabi.wordpress.com/ecbd/concepts-et-principes-du-data-mining/>![](Aspose.Words.ceeb7072-5c8f-4e76-8f0c-70d51bed5023.005.png)
...
Deux informations sont pertinentes parmi celles à notre disposition :![](Aspose.Words.ceeb7072-5c8f-4e76-8f0c-70d51bed5023.006.jpeg)
...
Fig 3 : Schéma Base de données <http://silico.biotoul.fr/enseignement/m1/datamining/projet/sujet.html>
...
Gene ID correspondent à nos individus (soient les lignes de la matrice). Les variables (attributs) choisis pour mener à bien la classification sont :
...
dbh=dbConnect(MySQL(),![](Aspose.Words.ceeb7072-5c8f-4e76-8f0c-70d51bed5023.007.png)

user="guest", password="bioinfo", dbname="fouille", host="195.220.42.4")

La première requête permet de récupérer la majorité des colonnes de notre matrice :

query = "SELECT Gene.GENE\_ID, Functional\_Domain.FD\_length, Functional\_Domain.FD\_ID, Conserved\_Domain.e\_Value![](Aspose.Words.ceeb7072-5c8f-4e76-8f0c-70d51bed5023.008.png)

FROM Functional\_Domain, Conserved\_Domain, Gene

WHERE Functional\_Domain.FD\_ID = Conserved\_Domain.FD\_ID AND Conserved\_Domain.GENE\_ID = Gene.GENE\_ID
...
The\_table1 <- df2 %>% group\_by(GENE\_ID) %>% filter(e\_Value == min(e\_Value)![](Aspose.Words.ceeb7072-5c8f-4e76-8f0c-70d51bed5023.009.png))
...
query = "SELECT subject\_id, norm\_Score![](Aspose.Words.ceeb7072-5c8f-4e76-8f0c-70d51bed5023.007.png)
...
Cette requête permet une sélection du subject\_id (équivalent au GENE\_ID donc qui nous permettra le lien entre les deux tables) et du score\_norm d'intérêt pour notre analyse. Les filtres s’effectueront via une e-value stringeante et des types de protéines uniquement ABC.

The\_table2 <- dft %>% group\_by(subject\_id)  %>% filter(norm\_Score == ![](Aspose.Words.ceeb7072-5c8f-4e76-8f0c-70d51bed5023.010.png)max(norm\_Score))
...
table =  merge(The\_table1, The\_table2, by = "GENE\_ID", all.x = TRUE, all.y ![](Aspose.Words.ceeb7072-5c8f-4e76-8f0c-70d51bed5023.011.png)= FALSE)

matrice = na.omit(table) matrice1 <- matrice1[,-4:-5]
...
conserved <- conserved[,-1] conserved <- conserved[,-2:-4] conserved <- conserved[,-4:-5]![](Aspose.Words.ceeb7072-5c8f-4e76-8f0c-70d51bed5023.012.png)

colnames(conserved)[1] <- "GENE\_ID"

matrice2 =  merge(matrice1, conserved, by = "GENE\_ID", all.x = TRUE, all.y = FALSE)
...
functional\_domains <- functional\_domains[,-2:-5] functional <- functional\_domains %>% group\_by(FD\_ID)![](Aspose.Words.ceeb7072-5c8f-4e76-8f0c-70d51bed5023.013.png) %>% filter(Family\_Link !="")
...
matriceFinal <- matriceFinal %>% group\_by(GENE\_ID) matriceFinal <- matriceFinal[,-1]![](Aspose.Words.ceeb7072-5c8f-4e76-8f0c-70d51bed5023.014.png)

write.table(matriceFinal, file="mymatrix.txt", row.names=FALSE, col.names=TRUE, sep ![](Aspose.Words.ceeb7072-5c8f-4e76-8f0c-70d51bed5023.015.jpeg)= '\t', append = FALSE, quote = FALSE)
...
![](Aspose.Words.ceeb7072-5c8f-4e76-8f0c-70d51bed5023.016.png)
...
- Application du théorème de Bayes 𝑃(*C*/𝑋)=(𝑃(𝑋/*C*)∗𝑃(*C*))/𝑃*(*𝑋) afin d’obtenir la probabilité à posteriori des classes
...
![](Aspose.Words.ceeb7072-5c8f-4e76-8f0c-70d51bed5023.017.png)![](Aspose.Words.ceeb7072-5c8f-4e76-8f0c-70d51bed5023.018.jpeg)
...
|*Sampling method*|*Number of validations*|*Parameters*|*Mean percentage error*|
| - | - | - | - |
|**Linear sampling**|10|Gain ratio / No pruning|6.520 %|
|||Gain ratio / MDL|6.476 %|
|||Gini index / No pruning|6.507 %|
|||Gini index / MDL|6.485 %|
||50|Gain ratio / No pruning|2.985 %|
|||Gain ratio / MDL|3.31 %|
|||Gini index / No pruning|3.34 %|
|||Gini index / MDL|3.311 %|


|*Sampling method*|*Number of validations*|*Parameters*|*Mean percentage error*|
| - | - | - | - |
|**Random sampling**|10|Gain ratio / No pruning|0.720 %|
...
|*Sampling method*|*Number of validations*|*Parameters*|*Mean percentage error*|
| - | - | - | - |
|**Stratified sampling**|10|Gain ratio / No pruning|0.687 %|
|||Gain ratio / MDL|0.762 %|
|||Gini index / No pruning|0.676 %|
|||Gini index / MDL|0.747 %|
||50|Gain ratio / No pruning|0.665 %|
|||Gain ratio / MDL|0.696 %|
|||Gini index / No pruning|0.676 %|
|||Gini index / MDL|0.705 %|
![](Aspose.Words.ceeb7072-5c8f-4e76-8f0c-70d51bed5023.019.png)![](Aspose.Words.ceeb7072-5c8f-4e76-8f0c-70d51bed5023.020.jpeg)
...
|*Sampling method*|*Number of validations*|*Mean percentage error*|
| - | - | - |
|**Linear sampling**|10|13.98 %|
||50|5.402 %|


|*Sampling method*|*Number of validations*|*Mean percentage error*|
| - | - | - |
|**Random sampling**|10|1.316 %|
||50|1.312 %|


|*Sampling method*|*Number of validations*|*Mean percentage error*|
| - | - | - |
|**Stratified sampling**|10|1.314 %|
||50|1.309 %|
- **DISCUSSION**
...
Il aurait cependant été intéressant d’utiliser d’autres méthodes de classification en vue de comparer leurs performances avec les méthodes abordées dans ce projet. Éventuellement, nous aurions pu tester la validation croisée où k=s (Leave-one-out). Néanmoins, cette dernière est nettement plus coûteuse en calcul que la K validation croisée sans être nécessairement meilleure. De plus, il existe une sous-estimation de l’erreur en cas de sur-apprentissage.
...
- **GESTION DE PROJET![](Aspose.Words.ceeb7072-5c8f-4e76-8f0c-70d51bed5023.021.jpeg)![](Aspose.Words.ceeb7072-5c8f-4e76-8f0c-70d51bed5023.022.jpeg)**
